...
public function clear_all_transients() {
    ...
    public function register_user($username, $password, $nom, $prenom, $num_tel, $poste) {
        global $wpdb;
    ...
    public function verify_user_password($username, $password) {
        global $wpdb;
        $user = $wpdb->get_row($wpdb->prepare("SELECT * FROM Benevoles WHERE nom = %s", $username));
