...
class SH4_Conf_Html_Admin_View_Datetime
{
	...
	public function render()
	{
		...
		$pnames = array(
			...
			'datetime_hide_schedule_reports', 'datetime_hide_bottom_date_navigation', 'datetime_month_slim_view',
	...
	// month slim view
		$monthSlimView = $this->ui->makeInputCheckbox( 'datetime_month_slim_view', '__Slim Month Schedule Grouped View__', 1, $values['datetime_month_slim_view'] );
		$moreInputs[] = $monthSlimView;
